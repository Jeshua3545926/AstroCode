// AstroIDE - Editor de Código Funcional
class AstroIDE {
    constructor() {
        this.editor = null;
...
<body>
    ...
    runCode() {
        if (this.currentFile.endsWith('.js')) {
            ...
            this.log('Solo se pueden ejecutar archivos JavaScript', 'warning');
        }
    }
    ...
    refreshExplorer() {
        this.log('Explorador actualizado', 'info');
    }
}

// Inicializar el IDE cuando el DOM esté listo
